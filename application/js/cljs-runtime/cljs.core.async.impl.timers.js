...
var i_13880 = (self__.level + (1));
while(true){
if((i_13880 <= (new_level + (1)))){
(update[i_13880] = self__.header);

var G__13881 = (i_13880 + (1));
i_13880 = G__13881;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13882 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13882[i]));
} else {
x__$2.forward.push((((i < links_13882.length))?(links_13882[i]):null));
}

if((i < links_13882.length)){
(links_13882[i] = x__$2);
} else {
links_13882.push(x__$2);
}
...
var i_13884 = (0);
while(true){
if((i_13884 <= self__.level)){
var links_13885 = (update[i_13884]).forward;
if((x__$1 === (((i_13884 < links_13885.length))?(links_13885[i_13884]):null))){
(links_13885[i_13884] = (x__$1.forward[i_13884]));

var G__13886 = (i_13884 + (1));
i_13884 = G__13886;
continue;
} else {
var G__13887 = (i_13884 + (1));
i_13884 = G__13887;
continue;
}
} else {
...
var G__13889 = nx;
var G__13890 = (level__$1 - (1));
x = G__13889;
level__$1 = G__13890;
continue;
} else {
var G__13891 = x;
var G__13892 = (level__$1 - (1));
x = G__13891;
level__$1 = G__13892;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__13894 = nx;
var G__13895 = (level__$1 - (1));
x = G__13894;
level__$1 = G__13895;
continue;
} else {
var G__13896 = x;
var G__13897 = (level__$1 - (1));
x = G__13896;
level__$1 = G__13897;
continue;
}
